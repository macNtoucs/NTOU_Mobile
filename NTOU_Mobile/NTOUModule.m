...
//#import "Foundation+NTOUAdditions.h"

@implementation NTOUModule
@synthesize tag,
shortName,
longName,
iconName,
...
- (void)applicationWillTerminate {
    ...
    // Keep in mind -[NTOU_MobileAppDelegate applicationWillTerminate] already writes NSUserDefaults to disk.
}
...
- (void)becomeActiveModule {
	UIViewController *visibleController = [[NTOUAppDelegate() rootNavigationController] visibleViewController];
