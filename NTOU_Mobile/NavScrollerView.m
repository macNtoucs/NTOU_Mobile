...
- (void)layoutSubviews {
    ...
    if (self.contentView.frame.size.width > self.frame.size.width + 10) {
        if (!self.leftScrollButton) {
            UIImage *leftScrollImage = [UIImage imageNamed:NTOUImageNameScrollTabLeftEndCap];
        ...
        if (!self.rightScrollButton) {
            UIImage *rightScrollImage = [UIImage imageNamed:NTOUImageNameScrollTabRightEndCap];
